            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">{{__('dashboard.home')}} </a>
                            </li>
                            {{-- <li class="breadcrumb-item"><a href="{{route('admin.vendors')}}">المتاجر </a>
                            </li> --}}
                            <li class="breadcrumb-item active">
                                {{__('dashboard.settings.means_of_delivery')}}                                </li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" id="basic-layout-form"> {{__('dashboard.settings.edit_means_of_delivery')}}   </h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form class="form" action="{{route('update.shippings.methods',$shippingMethods -> id)}}"
                                                  method="post"
